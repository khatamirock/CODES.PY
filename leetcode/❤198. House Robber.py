...
# ar=[4,1,5,8,2,6,5,8,9]
ar = [183, 219, 57, 193, 94, 233, 202, 154, 65, 240, 97, 234, 100, 249, 186, 66, 90, 238, 168, 128, 177, 235, 50, 81,
...
# https://www.youtube.com/watch?v=_Xz-_qY-_QY
def knapscck(ar, w):
    if not ar:
        return 0
    if len(ar) < 3:
        return max(ar)
    return max(ar[0] + knapscck(ar[2:], w), knapscck(ar[1:], w))
